...
// YouTube Playables team — presented as brand voices rather than real,
...
export const authors: Record<string, Author> = {
  editorial: {
    id: "editorial",
    name: "YouTube Playables Editorial",
    role: "Editorial Team",
    bio: "The YouTube Playables editorial team writes practical, no-nonsense guides about free browser games — how they work, how to get better, and why they are good for your brain. Every article is reviewed for accuracy before publication.",
    interests: ["Puzzle games", "Brain training", "Strategy guides", "Browser gaming"],
    avatar: "/images/authors/editorial.svg",
    social: "https://twitter.com/youtubeplayables",
  },
  mira: {
    id: "mira",
    name: "Mira Okafor",
    role: "Puzzle & Logic Editor",
    bio: "Mira is part of the YouTube Playables editorial team and focuses on logic puzzles, number games, and memory training. She enjoys breaking difficult strategies into small, repeatable habits.",
  ...
  dev: {
    ...
    bio: "Dev is part of the YouTube Playables editorial team. He covers arcade, reflex, and casual games, with a soft spot for timing-based high-score chases and relaxing browser breaks.",
  ...
  lena: {
    ...
    bio: "Lena is part of the YouTube Playables editorial team and writes about word games, trivia, and vocabulary. She believes a good word puzzle is the fastest five-minute brain warm-up there is.",
